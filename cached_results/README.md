...
| Task 1 | CPU | `task1/univariate_visualization.npz`, `task1/misspecified_tree.npz`, `task1/multivariate_mc_reps.csv` |
| Task 2 | CPU | `task2/*/long.csv` (1,000 seeds), plus `config.json` |
| Width shrinkage | GPU | `thm52/thm52_df_results.csv` (900 rows) |
